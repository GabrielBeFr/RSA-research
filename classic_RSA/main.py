...
if __name__ == '__main__':
    ...
    parser.add_argument("--version", action="store", type=str, default="RSA", help="RSA model: 'RSA', 'RD-RSA'")
    ...
    rsa = rsa_model(world, save_directory='papers_experiments/',version=args.version, alpha=args.alpha, depth=args.depth)
    # Run the RSA model
    world, listeners, speakers = rsa.run(args.verbose)
